...
export function ModelComparisonPage() {
  ...
  const validationErrors = useMemo(() => [
    ...
    ...(!Number.isFinite(conditions.azimuthElevationDeg) || conditions.azimuthElevationDeg < 0 || conditions.azimuthElevationDeg > 90 ? ["Azimuth-cut elevation must be from 0° to 90° above the horizon. Each model reports the nearest solved NEC grid row."] : []),

...
const diameterParameter: TemplateParameterDefinition = {
  ...
  minSI: 0.0005, maxSI: 0.025, stepSI: 0.0001, defaultSI: 0.002, decimals: 2,
...
export const antennaTemplateDefinitions: AntennaTemplateDefinition[] = [
  templateBase({
    ...
    startingParameters: (frequencyHz) => { const l = SPEED_OF_LIGHT_M_PER_S / frequencyHz; return { frequencyHz, totalLengthM: l * 0.475, heightM: Math.min(100, l * 0.5), wireDiameterM: 0.002 }; },
  ...
  templateBase({
    ...
    startingParameters: (frequencyHz) => { const l = SPEED_OF_LIGHT_M_PER_S / frequencyHz; return { frequencyHz, totalLengthM: l * 0.47, apexHeightM: Math.min(100, l * 0.35), includedAngleRad: 120 * Math.PI / 180, wireDiameterM: 0.002 }; },
  ...
  templateBase({
    ...
    startingParameters: (frequencyHz) => { const l = SPEED_OF_LIGHT_M_PER_S / frequencyHz; return { frequencyHz, totalLengthM: l * 0.47, centreHeightM: Math.min(100, l * 0.4), slopeAngleRad: 30 * Math.PI / 180, wireDiameterM: 0.002 }; },
  ...
  templateBase({
    ...
    startingParameters: (frequencyHz) => { const l = SPEED_OF_LIGHT_M_PER_S / frequencyHz; const radial = l * 0.24; return { frequencyHz, radiatorLengthM: l * 0.2375, radialLengthM: radial, baseHeightM: Math.min(60, Math.max(1, radial * 0.55)), radialCount: 4, radialDroopRad: 30 * Math.PI / 180, wireDiameterM: 0.004 }; },
  ...
  templateBase({
    ...
    startingParameters: (frequencyHz) => ({ frequencyHz, perimeterM: SPEED_OF_LIGHT_M_PER_S / frequencyHz * 1.02, bottomHeightM: 2, wireDiameterM: 0.002 }),
  ...
  templateBase({
    ...
    startingParameters: (frequencyHz) => ({ frequencyHz, perimeterM: SPEED_OF_LIGHT_M_PER_S / frequencyHz * 1.02, baseHeightM: 2, wireDiameterM: 0.002 }),

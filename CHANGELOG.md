...
- Made the installed WebView2 ground-radial acceptance checks insensitive to Windows CRLF line endings while retaining the exact adjacent `GE -1` / `GN 2` NEC-card requirement

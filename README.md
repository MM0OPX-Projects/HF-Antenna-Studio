...
Version 1.0.8 is the current maintenance release. The numerical validation scope remains the documented v1.0.0 campaign. It is engineering software, not a substitute for construction measurements or professional safety analysis.
...
4. Open **About** and confirm version `1.0.8`.
...
With explicit thanks to **EA1FUO and the AntennaSim contributors**, **HF Antenna Studio was forked from the GPL-licensed software [AntennaSim](https://github.com/EA1FUO/AntennaSim)** at audited commit `96e153ceefffd25819e42142d591ca811b4790d3`. AntennaSim supplied the original software foundation; its name, source, licence, Git authorship, and exact fork point are retained as permanent provenance. HF Antenna Studio's interface, packaging, modelling adapters, validation infrastructure, and product documentation have subsequently been extensively changed. This project is not affiliated with or endorsed by AN-SOF, EZNEC, 4NEC2, or their authors. 4NEC2 is used only as a separately installed validation comparator and is not distributed here.

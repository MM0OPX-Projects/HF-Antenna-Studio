...
- **G3TXQ broadband Hexbeam:** the corrected generator reproduces the published single-band M-driver/five-side-reflector plan-view topology and bare-wire starting dimensions. It does not model bowed three-dimensional spreaders, stacked multiband interaction, sag, insulation, tie points, centre-post/feed-line coupling or construction hardware. Its exact deck agrees across two NEC-2 builds, but no independently authored model or controlled physical measurement yet validates its impedance or pattern.

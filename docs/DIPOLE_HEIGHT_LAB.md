...
| A symmetric dipole cannot prove compass handedness or mirroring. | Valid and unresolved. Asymmetric Yagi/phased-array coordinate cases remain release-blocking in `VALIDATION_PLAN.md`. |
